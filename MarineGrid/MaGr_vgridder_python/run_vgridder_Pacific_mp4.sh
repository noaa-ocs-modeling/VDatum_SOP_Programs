...
# Example: Use the indices for Hawaii and another island (e.g., 4 and 15).I have 49 polygons
#SBATCH --array=0-48     
# ---------------------------------------------
...
export REF_DIR="/work2/noaa/vdatum/mojganr/work_adcirc/MaGr/out_marine_grid_in_files/"

mkdir -p logs
export VGRID_NWORKERS=${SLURM_CPUS_PER_TASK:-4}

python -u vgridder_nc_Pacific_mp4.py
