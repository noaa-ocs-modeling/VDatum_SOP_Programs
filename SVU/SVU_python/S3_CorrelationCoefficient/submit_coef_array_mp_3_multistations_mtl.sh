#!/bin/bash
#SBATCH -A vdatum
#SBATCH -J coef_mtl_matlabAligned
#SBATCH -t 1:00:00
#SBATCH --array=0-399
...
OUT_NC="coef_full_mtl_matlabAligned_multi_SLICE_${SLURM_ARRAY_TASK_ID}.nc"
...
echo "[$(date '+%F %T')] datum=mtl shard=${SLURM_ARRAY_TASK_ID}/${NCHUNKS} workers=${WORKERS}"
...
echo "[$(date '+%F %T')] DONE datum=mtl shard=${SLURM_ARRAY_TASK_ID}"
